 ...
 * });
 */
export function useGetRepoIssuesQuery(baseOptions: Apollo.QueryHookOptions<GetRepoIssuesQuery, GetRepoIssuesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetRepoIssuesQuery, GetRepoIssuesQueryVariables>(GetRepoIssuesDocument, options);
      }
export function useGetRepoIssuesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetRepoIssuesQuery, GetRepoIssuesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetRepoIssuesQuery, GetRepoIssuesQueryVariables>(GetRepoIssuesDocument, options);
        }
